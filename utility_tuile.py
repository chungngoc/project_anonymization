...
#Le but de cette métrique est de calculer la différence de zone de couverture dâ€™un individu durant les 12 semaines dâ€™étude.
#Lâ€™idée est la suivante : la métrique permet de vérifier que, globalement, la version anonymisée garde les informations de déplacement et de couverture dâ€™un individu.
#Pour ce faire on mesure le nombre de cellules différentes dans laquelle lâ€™utilisateur a séjourné.
#Le score est calculé de la manià¨re suivante :
...
#  0 : cellule à  la région Franà§aise
# -1 : cellule au pays
