...
#/\/\/\/\/\/\ Nom de la métrique: Extraction des Points dâ€™Intéràªts /\/\/\/\/\/\
#Le but de cette métrique est de détecter les points d'intéràªts d'un individu.
#Les points d'intéràªts correspondent aux lieux oà¹ l'utilisateur a le plus séjourné.
#
